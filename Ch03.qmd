...
```{=html}
<img src="_resources/images/Ch03-images/what-how-matrix.svg" alt="What-How Matrix">
```

```{=latex}
\includegraphics[width=0.8\textwidth]{_resources/images/Ch03-images/what-how-matrix.pdf}
